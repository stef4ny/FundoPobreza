...
Este projeto é uma aplicação Python com interface gráfica (GUI) desenvolvida em Tkinter, que realiza consultas periódicas a um banco de dados IBM iSeries (AS400) para monitorar a ocorrência de registros com erro STAPRE = 815.
